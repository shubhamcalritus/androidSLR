...
import com.moduser.login_signup.LoginFragment;
...
public class DrawerActivity extends AppCompatActivity
    ...
    final static String SPLASH_SCREEN = "splash";
    final static String LOGIN_SCREEN = "login";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myManager.setActivity(this);
        setContentView(R.layout.activity_drawer);
        ButterKnife.bind(this);
        initUIobjects();

        setDrawerState(false);
        frameContainer.setBackgroundResource(R.drawable.sample);
        new Handler().postDelayed(new Runnable() {
            public void run() {
                frameContainer.setBackgroundResource(R.color.transparent);
                LoginFragment loginFragment = new LoginFragment();
                getSupportFragmentManager().beginTransaction().add(R.id.frame_container, loginFragment,
                        "login").commit();
